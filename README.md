...
- - **Programming Essentals (Scripting in C#)**:
  ...
  - Constrained the character jump amount
  - Added sound effects to assets collisions
  - Added a time counter to the custom scene
  - Added a gamified version of the project, in which you get a win screen in case you get all collectibles in time, if not, you get a loose screen
- **Publishing**: Builded the project and published it to WebGL.

## Play It!
- **WebGL Build**: [https://play.unity.com/en/games/76870e81-8786-47f6-8da0-3cbc87c27a38/isabella-lucios-unity-essentials]

## How to Run Locally
- **Requirements**: Unity 6000.2.6f2 and Unity Hub.
- **Steps**:
  1. Clone this repo: `https://github.com/isabellalucioo/unity-essentials.git`
